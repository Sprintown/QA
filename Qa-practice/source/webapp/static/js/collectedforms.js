! function () {
    ...
    var F, O, x, C = h ? function (t, e, r) {
        ...
        K = {
            f: h ? Y : function (t, e) {
                ...
                if (J(t, e)) return E(!Q.f.call(t, e), t[e])
            }
        },
    ...
    var ht = {
        ...
        vt = function (t, e) {
            var r, n = W(t),
                i = 0,
                o = [];
            for (r in n) !J(it, r) && J(n, r) && o.push(r);
            for (; e.length > i;) J(n, r = e[i++]) && (~yt(o, r) || o.push(r));
            return o
        },
    ...
    var Xt = w.f,
        Jt = M("toStringTag"),
        Yt = function (t, e, r) {
            t && !J(t = r ? t : t.prototype, Jt) && Xt(t, Jt, {
                configurable: !0,
                value: e
            })
        },
    ...
    var de = Et.f,
        ...
        Ve = function (t) {
            ...
            return !(this === Pe && J(Ne, t) && !J(Ie, t)) && (!(e || !J(this, t) || !J(Ne, t) || J(this, ge) && this[ge][t]) || e)
        },
        ze = function (t, e) {
            t = W(t);
            e = f(e, !0);
            if (t !== Pe || !J(Ne, e) || J(Ie, e)) {
                var r = we(t, e);
        ...
        Qe = function (t) {
            for (var e, r = Te(W(t)), n = [], i = 0; r.length > i;) J(Ne, e = r[i++]) || J(it, e) || n.push(e);
            return n
        },
        He = function (t) {
            for (var e, r = t === Pe, n = Te(r ? Ie : W(t)), i = [], o = 0; n.length > o;) !J(Ne, e = n[o++]) || r && !J(Pe, e) || i.push(Ne[e]);
            return i
        };
    if (!k) {
        pt((Ae = function () {
        ...
        var Ye = {},
            Ke = function () {
                var t = arguments.length < 1 || void 0 === arguments[0] ? void 0 : String(arguments[0]),
                    e = this instanceof Ke ? new Je(t) : void 0 === t ? Je() : Je(t);
                "" === t && (Ye[e] = !0);
                return e
            };
        Ot(Ke, Je);
        var Ze = Ke.prototype = Je.prototype;
        Ze.constructor = Ke;
        var tr = Ze.toString,
...
! function (t) {
    ...
    r.p = "//static.hsappstatic.net/collected-forms-embed-js/static-1.425/";
    r(r.s = "nhqU")
}({
    "3eCO": function (t, e, r) {
        (function (e) {
        ...
        t.exports = {
            ...
            bender: {
                depVersions: {
                    ...
                    "browserslist-config-hubspot": "static-1.73",
                    csstype: "static-1.5",
                    "forms-embed-utils-lib": "static-1.154",
                    jasmine: "static-3.134",
                    "jasmine-runner": "static-1.307",
                    outpost: "static-1.191",
                    quartz: "static-1.535",
                    react: "static-7.96",
                    "react-dom": "static-7.62",
                    sinon: "static-1.9",
                    StyleGuideUI: "static-3.356"
                },
                depPathPrefixes: {
                    "collected-forms-embed-js": "/collected-forms-embed-js/static-1.425",
                    "browserslist-config-hubspot": "/browserslist-config-hubspot/static-1.73",
                    csstype: "/csstype/static-1.5",
                    "forms-embed-utils-lib": "/forms-embed-utils-lib/static-1.154",
                    jasmine: "/jasmine/static-3.134",
                    "jasmine-runner": "/jasmine-runner/static-1.307",
                    outpost: "/outpost/static-1.191",
                    quartz: "/quartz/static-1.535",
                    react: "/react/static-7.96",
                    "react-dom": "/react-dom/static-7.62",
                    sinon: "/sinon/static-1.9",
                    StyleGuideUI: "/StyleGuideUI/static-3.356"
                },
    ...
    nhqU: function (t, e, r) {
        ...
        const ie = [{
                test: t => {
                    try {
                        return t.getAttribute("action").indexOf(Jt) > -1
                    } catch (t) {
                        return !1
                    }
                },
