! function (factory) {
    ...
    instanceUid = 0, (Slick = function (element, settings) {
        ...
        return centerOffset = !0 === _.options.centerMode ? Math.floor(_.$list.width() / 2) : 0, swipeTarget = -1 * _.swipeLeft + centerOffset, !0 === _.options.swipeToSlide ? (_.$slideTrack.find(".slick-slide").each((function (index, slide) {
            ...
            if (slideOuterWidth = $(slide).outerWidth(), slideOffset = slide.offsetLeft, !0 !== _.options.centerMode && (slideOffset += slideOuterWidth / 2), swipeTarget < slideOffset + slideOuterWidth) return swipedSlide = slide, !1
...
//# sourceURL=https://cdn2.hubspot.net/hub/43808461/hub_generated/template_assets/134259115560/1694562920151/marketplace/Juice_Tactics_Snacks/Thrifty/js/slick.js