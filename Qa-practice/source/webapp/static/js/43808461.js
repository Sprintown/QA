...
var _hsq = _hsq || [];
var _paq = _paq || [];
_hsq.push(['setPortalId', 43808461]);
...
_hsq.push(['addCookieDomain', '.lemexplainit.com']);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/43808461.js', 'hs-script-loader']);
...
(function () {
    ...
    hstc.tracking.Tracker.prototype.initEventVisualizerScript = function () {
        const t = "eventVisualizerIsLocal",
            ...
            s = /^https:\/\/(app|local)(-[a-z]{2}[0-9]{1})?\.hubspot(qa)?\.com/,
            o = "hsExchangeCredentials";
        try {
            const c = localStorage.getItem(e) === i,
