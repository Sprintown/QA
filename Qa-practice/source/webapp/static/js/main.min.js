! function () {
    window.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (callback, thisArg) {
        ...
        $(window).on("scroll", (function () {
            $(window).scrollTop() > 50 ? $("#global-header").addClass("active") : $("#global-header").removeClass("active")
        }))
    }));
    ...
    }, ["interactive", "complete"].indexOf(document.readyState) >= 0 ? callback() : document.addEventListener("DOMContentLoaded", callback), jQuery.event.special.touchstart = {
...
//# sourceURL=https://cdn2.hubspot.net/hub/43808461/hub_generated/template_assets/134254133174/1694562923530/marketplace/Juice_Tactics_Snacks/Thrifty/js/main.js